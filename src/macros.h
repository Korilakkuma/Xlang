...
#define SIZE_OF_SYMBOL_TABLE 32767
...
#define generate_code(op) generate_code3(op, 0, 0)
#define generate_code2(op, data) generate_code3(op, 0, data)

#define LOCAL_SCOPE true
...
enum { FUNCTION_EXIT = 1, FUNCTION_INPUT, FUNCTION_PRINTF, FUNCTION_PRINTF_2 };
...
#ifdef DEBUG_CODE
char *opcodes[] = {"NOP",  "INC",  "DEC",   "NEG",  "NOT",  "ADD", "SUB",
                   "MUL",  "DIV",  "MOD",   "LESS", "LSEQ", "GRT", "GTEQ",
                   "EQ",   "NTEQ", "AND",   "OR",   "CALL", "DEL", "JMP",
                   "JPT",  "JPF",  "EQCMP", "LD",   "LDA",  "LDI", "ST",
